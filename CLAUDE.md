...
## Roadmap
Per-feature implementation history, shipped-feature changelog entries, and next-session candidates have been moved to `docs/RESEARCH_LOG.md` (newest at bottom) for context hygiene.
